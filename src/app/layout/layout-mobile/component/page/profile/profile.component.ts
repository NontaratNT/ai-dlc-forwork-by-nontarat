...
export class ProfileComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.servicePersonal.GetPersonalById(User.Current.PersonalId).subscribe(_ => {
            ...
            if (this.formData.USER_PICTURE) {
                this.userImagePath = environment.config.baseConfig.resourceUrl.replace("/ccib", "/bpm") + this.formData.USER_PICTURE + "?" + Date.now().toString();
            }
        });
    ...
    OnSerectProvice(e) {
        ...
        if (e.value) {
            ...
            this.formData.DISTICT_ID = null;
            this.formData.SUB_DISTICT_ID = null;
            this.formData.POST_CODE = null;
    ...
    OnSerectProviceHome(e) {
        ...
        if (e.value) {
            ...
            this.disableDistrict1 = true;
            this.disableSubDistrict1 = true;
            this.disablepostcode1 = true;
            this.formData.HOME_REGISTER_DISTICT_ID = null;
            this.formData.HOME_REGISTER_SUB_DISTICT_ID = null;
            this.formData.HOME_REGISTER_POST_CODE = null;
        }
    ...
    OnSelectProviceWork(e) {
        ...
        if (e.value) {
            ...
            this.disableDistrict2 = true;
            this.disableSubDistrict2 = true;
            this.disablepostcode2 = true;
            this.formData.WORK_DISTRICT_ID = null;
            this.formData.WORK_SUB_DISTRICT_ID = null;
            this.formData.WORK_POSTCODE_ID = null;
        }
