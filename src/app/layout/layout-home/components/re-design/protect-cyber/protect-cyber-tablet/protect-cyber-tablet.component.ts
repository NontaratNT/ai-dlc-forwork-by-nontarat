...
@Component({
  selector: 'app-protect-cyber-tablet',
  templateUrl: './protect-cyber-tablet.component.html',
  styleUrls: ['./protect-cyber-tablet.component.scss']
})
export class ProtectCyberTabletComponent implements OnInit {
  ...
  ngOnInit(): void {
    const container = this.el.nativeElement.querySelector('.scrollTabletContainer');
    if (container) {
