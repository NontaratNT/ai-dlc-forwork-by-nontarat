...
@Component({
  selector: 'app-protect-cyber-mobile',
  templateUrl: './protect-cyber-mobile.component.html',
  styleUrls: ['./protect-cyber-mobile.component.scss']
})
export class ProtectCyberMobileComponent implements OnInit {
  ...
  ngOnInit(): void {
    const container = this.el.nativeElement.querySelector('.scrollMobileContainer');
    if (container) {
