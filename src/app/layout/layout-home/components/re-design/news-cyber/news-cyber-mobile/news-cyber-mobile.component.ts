...
@Component({
  selector: 'app-news-cyber-mobile',
  templateUrl: './news-cyber-mobile.component.html',
  styleUrls: ['./news-cyber-mobile.component.scss']
})
export class NewsCyberMobileComponent implements OnInit, AfterViewInit {
