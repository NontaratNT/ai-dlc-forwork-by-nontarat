...
@Component({
    selector: 'app-date-combo-picker',
    templateUrl: './date-combo-picker.component.html',
    styleUrls: ['./date-combo-picker.component.scss']
})
export class DateComboPickerComponent implements OnInit, OnChanges {
    @Input() date;
    @Input() minDate;
    @Input() maxDate;
    @Input() months;
