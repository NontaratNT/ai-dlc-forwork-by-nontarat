...
@Component({
  selector: 'app-search-new-case-type',
  templateUrl: './search-new-case-type.component.html',
  styleUrls: ['./search-new-case-type.component.scss']
})
export class SearchNewCaseTypeComponent implements OnInit {
