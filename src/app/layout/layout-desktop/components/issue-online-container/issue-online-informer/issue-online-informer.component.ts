...
export class IssueOnlineInformerComponent implements OnInit {
    ...
    @ViewChild('formInformer5', { static: false }) formInformer5: DxFormComponent;
    @ViewChild('formInformerOther', { static: false }) formInformerOther: DxFormComponent;
    @ViewChild('formInformeraddresspolice', { static: false }) formInformeraddresspolice: DxFormComponent;
...
// ]
    ...
    async setPersonalData(){
        ...
        this.occupationList = await this.servOccupations.getOccupations().toPromise();
        ...
        if (this.mainConponent.formType === 'add') {
            ...
            if (this.userType === 'mySelf') {
                ...
                this.formData.OCCUPATIONS_ID = this.occupationList[0].OCCUPATIONS_ID ?? null;
                this.formData.OCCUPATIONS_NAME = this.occupationList[0].OCCUPATIONS_NAME ?? null;
            ...
            if (dataForm.INFORMER_CARD_DISTRICT_ID) {
                this.presentAddress.subDistrict = await this.serviceDistrict
                    .GetSubDistrictOfDistrict(dataForm.INFORMER_CARD_DISTRICT_ID)
                    .toPromise();
                this.presentAddress.disableSubDistrict = false;
            ...
            this._OrgService.getorgProvince(dataForm.INFORMER_PROVINCE).subscribe((_)=>{
                this.dsorgbyaria = _;
        });
    ...
    SubmitForm(e) {
        ...
        if (this.mainConponent.formType === 'add') {
            ...
            this.formData.CASE_INFORMER_FIRSTNAME = this.NameSanitize(this.formData.CASE_INFORMER_FIRSTNAME)
            this.formData.CASE_INFORMER_LASTNAME = this.NameSanitize(this.formData.CASE_INFORMER_LASTNAME)
            this.formData.INFORMER_EMAIL = this.EmailSanitize(this.formData.INFORMER_EMAIL)
            this.formData.INFORMER_TEL = this.PhoneNumberSanitize(this.formData.INFORMER_TEL)
            this.formData.INFORMER_TEL = this.PhoneNumberSanitize(this.formData.INFORMER_TEL)
