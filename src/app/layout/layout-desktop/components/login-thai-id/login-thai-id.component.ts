  ...
  async ngOnInit(): Promise<void> {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (paramValue) {
        ...
        this.thaiidservice.thaiIdgettokenGDCC(param).subscribe((res) => {
          console.log(res);
          if (!res.IsSuccess) {
            Swal.fire({
                title: 'ผิดพลาด!',
            ...
            this._userInfo = this._jwtServ.decodeToken(res.Value.id_token);
      ...
      this.userServ
        ...
        .subscribe(u => {
          if (u) {
            ...
            if(_.isConfirmed){
              this._isLoading = false;
              window.location.href = "https://thaipoliceonline.go.th/login/thaiD";
            }
          })
        }
      });
