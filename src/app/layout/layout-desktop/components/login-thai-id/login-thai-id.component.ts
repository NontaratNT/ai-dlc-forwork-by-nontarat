...
export class LoginThaiIDComponent implements OnInit {
  ...
  url = 'https://imauth.bora.dopa.go.th/api/v1/oauth2/auth/?response_type=code&client_id=R2lpZndIaEhmdHdxRTdweUNiMDRZNmx3Y1JzSTZSM3E&redirect_uri=https://officeruat.thaipoliceonline.com/login/thaiD&scope=pid%20th_fullname%20dob%20openid&state=af0ifjsldkj';
